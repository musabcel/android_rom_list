...
- **/e/** | [Github](https://gitlab.e.foundation) - [Web](https://e.foundation/)
...
- **BlissROM** | [Github](https://github.com/BlissRoms) - [Web](https://blissroms.com/)
...
- **Corvus-OS** | [Github](https://github.com/Corvus-ROM) - [Web](https://www.corvusrom.com/)
...
- **DotOS** | [Github](https://github.com/DotOS) - [Web](https://www.droidontime.com/)
- **Evolution X** | [Github](https://github.com/Evolution-X) - [Web](https://evolution-x.org/)
- **ExtendedUI** | [Github](https://github.com/Extended-UI) 
...
- **MalluOS** | [Github](https://github.com/MalluOS) - [Web](https://malluos.github.io/)
- **MoKee** | [Github](https://github.com/MoKee) - [Web](https://www.mokeedev.com/en/)
...
- **Potato Open Sauce Project (POSP)** | [Github](https://github.com/PotatoProject) - [Web](https://potatoproject.co/)
...
- **StyxOS** | [Github](https://github.com/StyxProject) - [Web](https://styxproject.ml/)
...
- **/e/** | [Web](https://doc.e.foundation/how-tos/install-GSI)
- **Ancient OS** | [Web](https://sourceforge.net/projects/ancientrom/files/gsi/)
- **Android S GSI** | [Telegram](https://t.me/androidsgsi)
- **AOSP by phhusson** | [Web](https://github.com/phhusson/treble_experimentations/releases)
- **BlissROM** | [Web](https://sourceforge.net/projects/treblerom/files/BLESS11/)
...
- **DotOS** | [Web](https://www.droidontime.com/devices)
